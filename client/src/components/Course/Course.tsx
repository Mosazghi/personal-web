...
const Course = ({ name, description, type, grade, urlLink }: CourseProps) => {
    return (
        <article className="gap-2 text-start bg-slate-100 rounded-lg px-[1em] py-[0.7em] pb-[0.5em] m-[1em] transition-all duration-300 ease-out items-stretch flex flex-col justify-stretch border-l-[10px] border-solid border-slate-500 shadow-lg min-w-[302px]">
